...
const loginClass =
  "font-medium px-5 py-2 transition duration-300 rounded-md border border-color1 text-color1 hover:bg-secondary";
const registerClass =
  "font-medium px-5 py-2 transition duration-300 rounded-md border border-secondary text-primary bg-color1 hover:opacity-80";

const Navbar = () => {
  return (
    <nav className="flex justify-center items-center font-inter min-h-[60px] px-6 py-4">
      <div className="xl:max-w-[1280px] w-full flex justify-between items-center">
        <Link className="text-color1 font-bold text-3xl">KYN</Link>
